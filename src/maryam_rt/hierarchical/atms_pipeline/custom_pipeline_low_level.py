...
class Generator4Embeds:
    ...
    def generate(self, image_embeds, text_prompt='', generator=None, low_level_image=None, low_level_latent=None):
        ...
        pipe = self.pipe
        low_level_image = self.low_level_image if low_level_image is None else low_level_image
        low_level_latent = self.low_level_latent if low_level_latent is None else low_level_latent
